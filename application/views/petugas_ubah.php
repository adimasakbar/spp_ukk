                  ...
                  <form class="formhorizontal" method="post" action="<?php echo base_url('petugas/update') ?>">
                        ...
                        <div class="form-group row">
                          <label class="col-sm-2 col-form-label">id_petugas</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" value="<?php echo $value->id_petugas; ?>" disabled>
                            </div>
                        ...
                        <div class="form-group row">
                           ...
                           <div class="form-group row">
                            <label class="col-sm-2 col-form-label">nama_petugas</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control" name="nama_petugas" value="<?php echo $value->nama_petugas; ?>" placeholder="password" required>
                            </div>
                          </div>
                        <div class="form-group row">
